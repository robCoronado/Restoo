...
export default function AddRestaurantForm({ toastRef, setLoading }) {
    ...
    const addRestaurant = async() => {
        ...
        //toastRef.current.show("El restaurante se ha agregado con exito", 3000)
...
function MapRestaurant({ isVisibleMap, setIsVisibleMap, setLocationRestaurant, toastRef }) {
    ...
    const confirmLocation = () => {
        ...
        toastRef.current.show("La Ubicacion se ha guardado correctamente.", 3000)
...
function FormAdd({ 
    ...
    const [callingCode, setCallingCode] = useState("502")
